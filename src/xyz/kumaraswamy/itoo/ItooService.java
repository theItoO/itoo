...
public class ItooService extends Service {
  ...
  public static final int MSG_FLAG_END = 2;
  ...
  static class IncomingHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
      ...
      } else if (msg.what == MSG_FLAG_END) {
        if (service.creator == null)
          return;
        Log.d(TAG, "Received Flag End Message");
        service.endService();
      } else {
  ...
  private void endService() {
    ...
    // TODO:
    //  call this some time later maybe
  ...
  public void onDestroy() {
    super.onDestroy();
    Log.d(TAG, "onDestroy() Itoo Service Destroy");
    try {
      data.put("running", "no");
    } catch (Exception e) {
      throw new RuntimeException(e);
